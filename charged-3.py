...
mix,q,e,T,nr=helpers.get_params(int(sys.argv[1]))
jobname = helpers.make_name(mix,q,e,T,nr)
mfile,ifile,tfile,efile= helpers.make_filenames(jobname)
...
### CHARGES
rigid.set_param('R',types=['A','B'],positions=[[-0.0104,0.,0.],[0.4673,0.,0.]],diameters=[1.0,.272],charges=[-4.658,4.658]) #full proper charges
rigid.create_bodies() 
